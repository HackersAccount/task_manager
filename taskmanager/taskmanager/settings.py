...
SECRET_KEY = 'django-insecure-&0$8!v1csu-%1$15j(xink92xizz)1h#-r6#5!i&$2^k-=-5b8'
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('DB_USER', 'neverknownuser'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'canolnlyguessmaybe123&*%'),
